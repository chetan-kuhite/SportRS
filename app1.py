...
# final_model = load_model("C:\\Users\\LEENA\\Desktop\\All Folders\\Chetans Projects\\Sport recogination\\93 accuracy h5\\IV3_LSTM4.h5")
...
class_labels = class_labels = ['VolleyballSpiking',
 'Biking',
 'HorseRiding',
 'Fencing',
 'Archery',
...
def predict_single_action(input_video_file_path, SEQUENCE_LENGTH):
    frames,frames_images = frames_extraction(input_video_file_path)
    plt.figure(figsize=(15, 3))
    for i in range(SEQUENCE_LENGTH):
        plt.subplot(1, 3, i + 1)
        plt.imshow(cv2.cvtColor(frames_images[i], cv2.COLOR_BGR2RGB))
        plt.axis('off')
...
def predict():
    ...
    predicted_class, plot_data, three_confidence, three_classes = predict_single_action(video_path, SEQUENCE_LENGTH)
